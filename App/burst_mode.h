 ...
 *  方案：IOUT 低于阈值时进入 Burst Mode，通过 VOUT 滞回比较间歇使能/失能
 *        PWM 输出，将 VOUT 维持在上/下门限之间。
 *
 *  行为：
...
#define BURST_VOUT_OFF_MV_DEF      24500   /* VOUT > 24.5V → 失能 PWM（burst off）*/

/* Burst 期间固定频率：300kHz（最低增益，最小能量传输）*/
#define BURST_PERIOD               40300U  /* 135kHz = 5440MHz / 45300 */
...
/* 主循环 SafeSM_Poll RUN 分支调用：IOUT 低于进入门限持续 5ms → 返回 1 */
